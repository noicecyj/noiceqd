            ...
            <Dialog title="菜单" visible={ pagemenuState.pagemenuVisible }
              ...
              <Form style={ { width: '100%' } } { ...pagemenuState.formItemLayout }
                ...
                <FormItem label="菜单代号:" required requiredMessage="请输入菜单代号">
                  <Input id="id" name="id" placeholder="请输入菜单代号" defaultValue="" />
                </FormItem>
                <FormItem label="菜单名称:" required requiredMessage="请输入菜单名称" >
                  <Input id="name" name="name" placeholder="请输入菜单名称" defaultValue="" />
                </FormItem>
                <FormItem label="菜单路径:" required requiredMessage="请输入菜单路径">
                  <Input id="path" name="path" placeholder="请输入菜单路径" defaultValue="" />
                </FormItem>
                <FormItem label="组件名称:" requiredMessage="请输入组件名称">
                  <Input id="componentName" name="componentName" placeholder="请输入组件名称" defaultValue="" />
                </FormItem>
                <FormItem label="接口路径:" requiredMessage="请输入接口路径">
                  <Input id="apiPath" name="apiPath" placeholder="请输入接口路径" defaultValue="" />
                </FormItem>
                <FormItem label="排序代码:" required requiredMessage="请输入排序代码">
                  <Input id="sortCode" name="sortCode" placeholder="请输入排序代码" defaultValue="" />
                </FormItem>
                <FormItem label="菜单图标:">
                  <Input id="icon" name="icon" placeholder="请输入菜单图标" defaultValue="" />
                </FormItem>
              </Form>
            </Dialog>
          </div>
